...
Public Class AcumuladoPega3ContY
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "AcumuladoPega3ContY.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAcumuladoPega3ContY
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AcumuladoPega3ContY = New AcumuladoPega3ContY()
        rpt.Site = Me.Site
        Return rpt
    End Function
